...
Phase 1.12.0 为文档和设计规范阶段，未改动运行时代码。Phase 1.12.1、Phase 1.12.2、Phase 1.12.3、Phase 1.12.4 和 Phase 1.12.5 已接入运行时代码，但不改首页文档 schema。
...
- 将下一步主线推进到 Phase 1.12.6 后续组件候选设计。
