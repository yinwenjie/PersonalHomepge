...
Phase 1.6.6 新增了账号偏好字段迁移；Phase 1.6.7、1.6.7b 和 1.6.8 仅做前端状态、导出和模板生成能力收口。它们都没有改变同步码协议或首页文档 schema。由于主域名尚未决定，原主域名准备后移到 Phase 1.9 正式推出前收口；Phase 1.6 的剩余重点转为浏览器收藏/标签导入 v1。
