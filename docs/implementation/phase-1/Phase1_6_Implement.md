...
这两个收口阶段没有新增 Supabase SQL，也没有改变同步码协议。后续 Phase 1.6 的剩余重点从账号托管主链路转向偏好编辑、空间新同步码、导出和部署域名回归。
...
| Phase 1.6.6 | 待实现 | 全局偏好编辑 | 语言、主题、字体、默认搜索引擎等偏好可编辑 |
