...
Phase 1.6.6 新增了账号偏好字段迁移；Phase 1.6.7 和 1.6.7b 仅做前端状态收口和安全导出。它们都没有改变同步码协议或首页文档 schema。后续 Phase 1.6 的剩余重点转向部署域名回归。
...
| Phase 1.6.8 | P1 | 待实现 | 主域名准备 | 自购主域名、Auth redirect、`basePath` 和缓存隔离回归 | M | High |
