...
Phase 1.13 聚焦正式主域名前的产品化体验收口，目标是补齐设置页扩展、首页标题、搜索引擎识别、主题风格 v2 和主域名准备。多语言支持已独立为 Phase 1.14，放在主域名准备之后集中实现。Phase 1.13.0 已完成设置页信息架构 v2。
...
下一步进入 Phase 1.13.1 产品身份收口。该阶段优先补齐可编辑页面标题和搜索引擎 logo；多语言支持延后到 Phase 1.14，并继续保持语言偏好不进入首页文档。
