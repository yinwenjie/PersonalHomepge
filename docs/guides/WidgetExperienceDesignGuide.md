...
| Todo List | 支持新增、完成、编辑、删除、上移/下移、清除完成 | 空状态只给出静态文本；移动端任务行内按钮较密；缺少轻量筛选；完成项和未完成项的视觉层级还可更清晰 | Phase 1.12.2 |
...
| Phase 1.12.2 | Todo 优化要保持轻量，关注输入、完成项、筛选和移动端点击区域 | 不做截止日期、提醒、标签、子任务或任务级同步 |
