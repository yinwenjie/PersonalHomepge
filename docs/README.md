...
- `implementation/phase-1/Phase1_11_Implement.md`：Phase 1.11，数据保全与恢复体系；记录文档分类、本地历史版本、数据恢复中心、危险写入保护、同步误覆盖防护、账号托管云端历史版本和账号托管可恢复模型收口。
...
- `backlog/DataPreservationBacklog.md`：Phase 1.11 数据保全与恢复体系 backlog，记录本地/云端快照、数据恢复中心、危险写入保护、同步误覆盖防护和后台审计设计。
